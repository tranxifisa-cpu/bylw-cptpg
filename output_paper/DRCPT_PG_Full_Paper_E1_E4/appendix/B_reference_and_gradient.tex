...
It remains to translate a nonzero reference gap into a CPT-value gap.  A deterministic relative outcome $y$ has survival function equal to one below its corresponding value magnitude and zero above it.  Since $w_\pm^\eps(0)=0$ and $w_\pm^\eps(1)=1$, its CPT value is
