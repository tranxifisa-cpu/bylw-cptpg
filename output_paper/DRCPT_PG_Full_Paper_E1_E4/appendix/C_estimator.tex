...
\[
 \mathfrak \mathfrak h_1(x')=\E_{\mathsf X}\{\mathcal K(\mathsf X,x')\}.
\]
Then $\E \mathfrak h_1(\mathsf X')=0$.  Put
$\mathcal K^\circ(x,x')=\mathcal K(x,x')-\mathfrak \mathfrak h_1(x')$.  Both first-order projections of $\mathcal K^\circ$ vanish:
\[
