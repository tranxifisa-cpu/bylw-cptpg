...
Fix any admissible estimator design parameters $(n,\varrho,b)$ from \Cref{thm:estimator}.  The common model-class constants in Definition \ref{def:minimax-oracle} make
\[
