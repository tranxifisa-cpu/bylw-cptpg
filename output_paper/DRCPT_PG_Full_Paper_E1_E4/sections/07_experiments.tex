...
\begin{figure}[t]
    ...
    \caption{Experimental evidence map.  E1--E4 form the theory-aligned core: mechanism, estimator, online tracking, and robustness.  E5--E7 extend the chain to chronological market outcomes, held-out investor behavior, and calibrated heterogeneous interaction.  The external-validity layers preserve separate estimands rather than using portfolio performance or simulated satisfaction as substitutes for the E2--E4 statistical and tracking diagnostics.}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/e5_external_validity.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/e6_behavior_alignment.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/e7_heterogeneous_agents.pdf}
